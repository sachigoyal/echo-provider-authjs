/**
 * 
 * from: https://github.com/Merit-Systems/echo/blob/master/packages/sdk/auth-js-provider/src/index.ts
 * slightly modified to fix error:
 * 
 * ```
 * client: {
